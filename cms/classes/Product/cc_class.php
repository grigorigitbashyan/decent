<?php
    ...
    */
    class CC_Utility {
        ...
        var $login = 'harvest2009'; //Username for your account
        var $password = 'preserves'; //Password for your account
        var $apikey = 'FBVtggIk5lAzEU9H';//'1102586888891'; // API Key for your account.
        ...
        */    
        protected function doServerCall($request, $parameter = '', $type = "GET") {
           ...
           if ($this->curl_debug) {   $error = curl_error($ch);   }
            return $error;
           curl_close($ch);
